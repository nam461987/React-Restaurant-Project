...
class ComponentTable extends Component {
    ...
    componentDidMount() {
        this.props.getAccounts(this.state.page, this.state.rowsPerPage);
    }
    ...
    resendActiveEmailClick = id => {
        this.props.resendAciveEmail(id);
    }
    ...
    handleChangePage = (event, page) => {
        this.props.getAccounts(page, this.state.rowsPerPage);
        this.setState({ page, selected: [] });
    };

    handleChangeRowsPerPage = event => {
        this.props.getAccounts(0, event.target.value);
                                ...
                                .map(n => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {n.Active == 0 && user.permissions.includes(obj.resendActiveEmailPermission) ?
                                                <TableCell component="th" scope="row" align="center"
                                                    onClick={event => event.stopPropagation()}>
                                                    <Icon onClick={event => this.resendActiveEmailClick(n.Id)} className="text-20">local_post_office</Icon>
                                                </TableCell> : 
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({
        ...
        setStatus: Actions.setAccountStatus,
        resendAciveEmail: Actions.resendAciveEmail
    }, dispatch);
}

function mapStateToProps({ admin, SharedReducers, auth }) {
    return {
