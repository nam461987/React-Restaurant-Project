...
class ComponentTable extends Component {
    ...
    componentDidMount() {
        this.props.getPermissions(this.state.page, this.state.rowsPerPage);
    }
    ...
    handleChangePage = (event, page) => {
        this.props.getPermissions(page, this.state.rowsPerPage);
        this.setState({ page, selected: [] });
    };

    handleChangeRowsPerPage = event => {
        this.props.getPermissions(0, event.target.value);
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({
        ...
        setStatus: Actions.setPermissionStatus
    }, dispatch);
}

function mapStateToProps({ admin, SharedReducers }) {
    return {
        Items: admin.permissions.data,
