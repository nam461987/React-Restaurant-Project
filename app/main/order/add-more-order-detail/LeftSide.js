...
class LeftSide extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (!_.isEqual(this.props.editAddMoreOrder, prevProps.editAddMoreOrder)) {
            const steps = this.getSteps();
            const { editAddMoreOrder } = this.props;
            this.setState({
                categoryPicked: editAddMoreOrder.CategoryId,
                menuPicked: editAddMoreOrder.MenuId,
                menuNamePicked: editAddMoreOrder.MenuIdName,
                pricePicked: editAddMoreOrder.MenuPriceId,
                quantityPicked: editAddMoreOrder.Quantity,
                description: editAddMoreOrder.Description,
                sizeIdPicked: editAddMoreOrder.SizeId,
                sizeNamePicked: editAddMoreOrder.SizeIdName,
                            ...
                            <Card square>
                                ...
                                <div className="flex justify-center pb-32">
                                    <Button variant="contained" color="secondary" className="w-128"
                                        onClick={() => this.acceptAddMoreOrder()}>Accept</Button>
                                </div>
                            </Card>
                        </div>
                    )
    ...
    acceptAddMoreOrder = () => {
        ...
        this.props.acceptAddMoreOrder(obj);
        this.props.refresh();
        this.setState({
            categoryPicked: null,
            menuPicked: null,
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({
        ...
        acceptAddMoreOrder: Actions.acceptAddMoreOrder
    }, dispatch);
}
...
function mapStateToProps({ auth, order }) {
    return {
        ...
        editAddMoreOrder: order.addMoreOrders.editAddMoreOrder
    }
}
