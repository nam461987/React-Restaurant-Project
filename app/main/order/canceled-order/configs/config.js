...
obj.fields = [
    ...
    { field: "Code", label: "Order #", create: false, edit: false, list: true, align: 'left', disablePadding: false, sort: true },
    ...
    { field: "CustomerId", label: "Customer", view: 'Name', create: true, edit: true, list: true, type: 'select', option: '/option/getcustomer', align: 'left', disablePadding: false, sort: true },
